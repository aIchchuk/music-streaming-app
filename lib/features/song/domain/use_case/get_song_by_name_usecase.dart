...
class GetSongByNameUsecase
    implements UsecaseWithParams<List<SongEntity>, String> {
  final ISongRepository _songRepository;

  GetSongByNameUsecase({required ISongRepository songRepository})
      : _songRepository = songRepository;

  @override
  Future<Either<Failure, List<SongEntity>>> call(String name) {
    return _songRepository.getSongByName(name);
  }
}
