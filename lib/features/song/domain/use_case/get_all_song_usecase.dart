...
class GetAllSongUsecase implements UsecaseWithoutParams<List<SongEntity>> {
  final ISongRepository _songRepository;

  GetAllSongUsecase({required ISongRepository songRepository})
      : _songRepository = songRepository;

  @override
  Future<Either<Failure, List<SongEntity>>> call() {
    return _songRepository.getAllSong();
  }
}
