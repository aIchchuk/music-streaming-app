...
class RemoveSongFromAlbumUsecase implements UsecaseWithParams<AlbumEntity, AddRemoveSongParams> {
  final IAlbumRepository _albumRepository;

  RemoveSongFromAlbumUsecase({required IAlbumRepository albumRepository})
      : _albumRepository = albumRepository;

  @override
  Future<Either<Failure, AlbumEntity>> call(AddRemoveSongParams params) {
    return _albumRepository.removeSongFromAlbum(params.albumId, params.songId);
  }
}
